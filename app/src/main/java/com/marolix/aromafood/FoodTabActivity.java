...
public class FoodTabActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new FragFoodCourt(), "CHAT");
        adapter.addFrag(new FragRestaurant(), "STATUS");
        adapter.addFrag(new FragSpecial(), "CALLS");
