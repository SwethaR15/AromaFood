...
//                    JSONObject object = new JSONObject(response.body());
                    ...
                    Utilities.setPrefernc(SplashActivity.this, Constants.CATEGORY_1, response.body().getCategoryOne());
                    Utilities.setPrefernc(SplashActivity.this, Constants.CATEGORY_2, response.body().getCategoryTwo());
                    Utilities.setPrefernc(SplashActivity.this, Constants.CATEGORY_3, response.body().getCategoryThree());
...
//                pd.dismiss();
                ...
                Toast.
                        makeText(SplashActivity.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
